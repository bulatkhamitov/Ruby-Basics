class Menu
  ...
  def create_train
    ...
    when 1
      ...
      puts "------------------------"
      @engines << PassengerTrain.new(tr_number)
    ...
    when 2
      ...
      tr_number = gets.chomp!
      puts "------------------------"
      @engines << CargoTrain.new(tr_number)
  ...
  def train_list
    ...
    st = gets.to_i
    puts "------------------------"
    @depots[st].trains.each { |train| puts train.tr_number}
  end
  ...
  def train_choice
    puts "------------------------"
    @engines.each_with_index { |train, index| puts "#{train.tr_number} - Train [#{index}]"}
    puts "------------------------"
